            ...
            <div class="card-body">
                <div class="row d-flex">
                    ...
                    <div class="col-md-3 col-sm-4 text-center items-center mt-2 ">
                        ...
                        <div class="breadcrumb-item d-inline">Officer</div>
                    </div>
                    {{-- Akhir Breadcrumb --}}
                </div>
            </div>
            ...
            <div class="collapse" id="collapseExample" style="">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" id="reset" href="/officer" class="btn btn-secondary mb-1" title="Reset">
    ...
    <script>
        document.body.addEventListener("click", function(event) {
            ...
            if (element.classList.contains("tombol-export")) {
                swal({
                        title: 'Apakah anda yakin?',
                        text: 'Ingin export data Officer ini?',
                    ...
                    .then((willExport) => {
                        if (willExport) {
                            swal('Data Officer berhasil diexport!', {
                                icon: 'success',
                            });

                            // Make an AJAX request to trigger the export
                            fetch('{{ route('officer.export') }}', {
                                    method: 'GET',
                                })
                                .then(response => {
                            ...
                            swal('Data Officer tidak jadi diexport!');
                        }
                    });
            }
        })
