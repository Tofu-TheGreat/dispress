                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-">
                                <h4 class="text-primary">Edit Data Surat Tugas</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body ">
                        <form action="{{ route('surat-tugas.update', $editDataSuratTugas->id_surat_tugas) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="text" name="id_surat_tugas" id="" hidden
                                value="{{ $editDataSuratTugas->id_surat_tugas }}">
                                            ...
                                            <select
                                                ...
                                                @foreach ($klasifikasiList as $data)
                                                    <option value="{{ $data->id_klasifikasi }}"
                                                        {{ $editDataSuratTugas->id_klasifikasi == $data->id_klasifikasi ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $editDataSuratTugas->nomor_surat_tugas }}" id="nomor_surat_tugas"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="summernote @error('dasar') is-invalid @enderror" placeholder="ex: Perihal rapat paripurna"
                                            id="dasar" name="dasar" required> {{ $editDataSuratTugas->dasar }} </textarea>
                                        <span class="text-danger">
                                            @error('dasar')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $editDataSuratTugas->tujuan_pelaksanaan }}"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="summernote @error('tempat_pelaksanaan') is-invalid @enderror"
                                            placeholder="ex: Perihal rapat paripurna" id="tempat_pelaksanaan" name="tempat_pelaksanaan" required> {{ $editDataSuratTugas->tempat_pelaksanaan }} </textarea>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ $editDataSuratTugas->tanggal_mulai }}" id="tanggal_mulai"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date"
                                                ...
                                                placeholder="ex: 11/14/2023"
                                                value="{{ $editDataSuratTugas->tanggal_selesai }}" id="tanggal_selesai"
