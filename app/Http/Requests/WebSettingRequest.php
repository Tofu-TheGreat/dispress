...
class WebSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'header_surat' => 'required|string|max:80',
            'kota_user' => 'required|string|max:80',
    ...
    public function messages(): array
    {
        return [
            ...
            'header_surat.max' => 'Kolom Header Surat tidak boleh lebih dari 80 karakter.',
            'kota_user.required' => 'Kolom Kota User harus diisi.',
            'kota_user.string' => 'Kolom Kota User harus berupa teks.',
            'kota_user.max' => 'Kolom Kota User tidak boleh lebih dari 80 karakter.',
