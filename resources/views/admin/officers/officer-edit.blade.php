                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="ex: IV-C" value="{{ $data->golongan }}" id="golongan"
                                                    name="golongan">
                                            </div>
                                            <span class="text-danger">
                                                @error('golongan')
        ...
        document.body.addEventListener("click", function(event) {
            ...
            if (element.classList.contains("tombol-hapus-profile")) {
                swal({
                    ...
                    text: 'Ingin menghapus foto profile Officer ini?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: true,
                }).then((willDelete) => {
                    if (willDelete) {
                        swal('Foto profile Officer berhasil dihapus!', {
                            icon: 'success',
                        });
                        ...
                        swal('Foto profile Officer tidak jadi dihapus!');
                    }
                });
            }
        });
