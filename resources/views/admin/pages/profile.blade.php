                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="ex: Pembina Utama Muda"
                                                                    value="{{ $dataProfile->pangkat }}" id="pangkat"
                                                                    name="pangkat">
                                                            </div>
                                                            <span class="text-danger">
                                                                @error('pangkat')
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="capitalize" for="jenis_kelamin">Pilih Jenis
                                                                Kelamin: </label>
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="L"
                                                                    {{ $dataProfile->jenis_kelamin == 'L' ? 'selected' : '' }}>
                                                                    Laki-Laki
                                                                </option>
                                                                <option value="P"
                                                                    {{ $dataProfile->jenis_kelamin == 'P' ? 'selected' : '' }}>
                                                                    Perempuan
                                                                </option>
                                                            </select>
