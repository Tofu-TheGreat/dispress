                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select
                                                    ...
                                                    id="tujuan_pengajuan" name="tujuan_pengajuan" disabled>
                                                    <option selected disabled></option>
                                                    <option value="0"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 0 ? 'selected' : '' }}>
                                                        Kepala Sekolah</option>
                                                    <option value="1"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 1 ? 'selected' : '' }}>
                                                        Wakil Kepala Sekolah</option>
                                                    <option value="2"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 2 ? 'selected' : '' }}>
                                                        Kurikulum</option>
                                                    <option value="3"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 3 ? 'selected' : '' }}>
                                                        Kesiswaan</option>
                                                    <option value="4"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 4 ? 'selected' : '' }}>
                                                        Sarana Prasarana</option>
                                                    <option value="5"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 5 ? 'selected' : '' }}>
                                                        Kepala Jurusan</option>
                                                    <option value="6"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 6 ? 'selected' : '' }}>
                                                        Hubin</option>
                                                    <option value="7"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 7 ? 'selected' : '' }}>
                                                        Bimbingan Konseling</option>
                                                    <option value="8"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 8 ? 'selected' : '' }}>
                                                        Guru Umum</option>
                                                    <option value="9"
                                                        {{ $detailDataDisposisi->pengajuan->tujuan_pengajuan == 9 ? 'selected' : '' }}>
                                                        Tata Usaha</option>
                                                </select>
                                            </div>
